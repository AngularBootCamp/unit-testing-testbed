# Angular Boot Camp example: unit-testing-testbed
...
**[StackBlitz for unit-testing-testbed](https://stackblitz.io/github/AngularBootCamp/unit-testing-testbed)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/unit-testing-testbed.git
cd unit-testing-testbed
npm install
npm start
```
